    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">
                <i class="fas fa-edit mr-2"></i> Editar Situación Atípica
            </h2>
            ...
            <form method="POST" action="<?php echo Router::url('/situations/update/' . $situation['id']); ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="comedor_id" name="comedor_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                        ...
                        <option value="<?php echo $comedor['id']; ?>" <?php echo $comedor['id'] == $situation['comedor_id'] ? 'selected' : ''; ?>>
                ...
                <div>
                    ...
                    <select id="tipo" name="tipo" required class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                        ...
                        <option value="contratacion" <?php echo $situation['tipo'] == 'contratacion' ? 'selected' : ''; ?>>Contratación</option>
                        <option value="despido" <?php echo $situation['tipo'] == 'despido' ? 'selected' : ''; ?>>Despido</option>
                        <option value="incapacidad" <?php echo $situation['tipo'] == 'incapacidad' ? 'selected' : ''; ?>>Incapacidad</option>
                        <option value="evento_especial" <?php echo $situation['tipo'] == 'evento_especial' ? 'selected' : ''; ?>>Evento Especial</option>
                        <option value="dia_festivo" <?php echo $situation['tipo'] == 'dia_festivo' ? 'selected' : ''; ?>>Día Festivo</option>
                        <option value="otro" <?php echo $situation['tipo'] == 'otro' ? 'selected' : ''; ?>>Otro</option>
                    </select>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="fecha_inicio" name="fecha_inicio" required 
                               value="<?php echo htmlspecialchars($situation['fecha_inicio']); ?>"
                    ...
                    <div>
                        ...
                        <input type="date" id="fecha_fin" name="fecha_fin"
                               value="<?php echo htmlspecialchars($situation['fecha_fin'] ?? ''); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                ...
                <div>
                    ...
                    <input 
                        ...
                        required
                        value="<?php echo htmlspecialchars($situation['impacto_comensales']); ?>"
                ...
                <div>
                    ...
                    <?php
                    $turnosAfectadosArray = !empty($situation['turnos_afectados']) ? explode(',', $situation['turnos_afectados']) : [];
                    ?>
                    <div class="space-y-2">
                        <?php foreach ($turnos as $turno): ?>
                        <label class="inline-flex items-center mr-6">
                            <input type="checkbox" name="turnos_afectados[]" value="<?php echo htmlspecialchars($turno['nombre']); ?>" 
                                   <?php echo in_array($turno['nombre'], $turnosAfectadosArray) ? 'checked' : ''; ?>
                                   class="rounded">
