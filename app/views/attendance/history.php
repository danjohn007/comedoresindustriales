    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        <form method="GET" action="<?php echo Router::url('/attendance/history'); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div class="flex items-end space-x-2">
                ...
                <a href="<?php echo Router::url('/attendance/history'); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-lg" title="Restaurar filtros">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-600">
                                <?php 
                                    ...
                                    if (strlen($observaciones) > 50) echo '...'; 
                                ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t flex items-center justify-between">
            <div class="text-sm text-gray-600">
                Mostrando <?php echo count($records); ?> de <?php echo $pagination['total_records']; ?> registros
            </div>
